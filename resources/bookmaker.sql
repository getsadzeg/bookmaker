...
ALTER TABLE BET ADD COLUMN book_id INT REFERENCES BOOK(id);
ALTER TABLE BET ADD COLUMN RESULT VARCHAR(30);
ALTER TABLE BET DROP COLUMN coefficient;
AlTER TABLE BOOK ADD COLUMN MONEY REAL;
ALTER TABLE BOOK ADD COLUMN user_id INT;
ALTER TABLE BET ALTER COLUMN id TYPE INT;
